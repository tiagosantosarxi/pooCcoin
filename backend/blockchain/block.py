...
class Block:
    ...
    def adjust_difficulty(last_block, new_timestamp):
        ...
        :return:
        """
        print(f'new_timestamp - last_block.timestamp = {new_timestamp - last_block.timestamp}')
        print(f'MINE_RATE = {MINE_RATE}')
...
def main():
    ...
    block = Block.mine_block(genesis_block, 'foooooooo')
    print(block)
